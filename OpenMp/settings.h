...
namespace settings{
    ...
    constexpr int x_global_grid_size {256};
    constexpr int y_global_grid_size {256};
    constexpr int z_global_grid_size {256};
    ...
    constexpr int z_num_processes {4};
