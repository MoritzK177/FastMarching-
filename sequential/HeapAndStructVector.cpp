...
#include <array>
#include <vector>
int arr_index(int, int, int);//forward declaration
...
double MinHeap::weight_at_index(const int i)
{
    return harr[i].weight;
}
...
WeightedPoint MinHeap::extractMin()
{
    ...
    table[arr_index( harr[0].m_x,harr[0].m_y, harr[0].m_z)]=0;
    harr.pop_back();
    heap_size--;
    MinHeapify(0);
